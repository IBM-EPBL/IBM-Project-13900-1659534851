...
conn = ibm_db.connect("DATABASE=;HOSTNAME=.databases.appdomain.cloud;PORT=32733;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=;PWD=",'','')
...
def apply():
    ...
    if request.method == 'POST' :
        ...
        session['loggedin'] = True
        TEXT = "Hello Candidate, a new appliaction for job position" +jobs+"is requested"
